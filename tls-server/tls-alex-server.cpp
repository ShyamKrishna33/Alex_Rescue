...
void handleCommand(void *conn, const char *buffer)
{
	...
	switch(cmd)
	{
		case 'w':
		case 'W':
commandPacket.command = COMMAND_FORWARD_S;
		...
		case 's':
          case 'S':
commandPacket.command = COMMAND_REVERSE_S;
			uartSendPacket(&commandPacket);
			break;
          case 'd':
          case 'D':
commandPacket.command = COMMAND_TURN_RIGHT_S;
			uartSendPacket(&commandPacket);
			break;
          case 'a':
          case 'A':
commandPacket.command = COMMAND_TURN_LEFT_S;
			uartSendPacket(&commandPacket);
			break;
          case 'i':
          case 'I':
commandPacket.command = COMMAND_FORWARD_L;
			uartSendPacket(&commandPacket);
			break;
          case 'k':
          case 'K':
commandPacket.command = COMMAND_REVERSE_L;
			uartSendPacket(&commandPacket);
			break;
          case 'l':
          case 'L':
commandPacket.command = COMMAND_TURN_RIGHT_L;
			uartSendPacket(&commandPacket);
			break;
          case 'j': 
          case 'J':
commandPacket.command = COMMAND_TURN_LEFT_L;
			uartSendPacket(&commandPacket);
			break;
